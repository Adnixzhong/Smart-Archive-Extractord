...
## 关键路径
- `main.py` — 入口
- `ui/app.py` — 主界面 (`SmartExtractorApp`)，含全部智能解压逻辑与揭皮算法
...
| | ☑ 智能模式（默认） | ☐ 普通模式 |
|---|---|---|
| 解压方式 | 外层解压到临时工作区 → 揭皮 → 移入输出 | 直接解压到输出目录 |
| 嵌套处理 | 递归揭皮，所有嵌套压缩包就地解压 | 不解压任何嵌套压缩包 |
| 文件夹结构 | 揭皮后统一展平 | 完整保留原始结构 |
